...
- `SliceToView` - this function is mainly self explanatory. This function converts a built-in go slice into a [View](https://github.com/Polshkrev/gopolutils/blob/main/docs/en-UK/collections/view.md).
